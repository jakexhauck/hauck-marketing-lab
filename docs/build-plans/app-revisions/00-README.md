...
## Run order (important — some plans share files)
Plans `06` and `07` both restructure the Marketing nav. **Run `06` first and merge it
before starting `07`.** All other plans (`01`-`05`, `08`) touch disjoint files and can
run in any order / in parallel worktrees.

| Plan | Page | Type | Depends on |
|---|---|---|---|
| 01 | Paid Ads | Real UI + data | - |
| 02 | Google Reviews | Real UI + data | - |
| 03 | Website | Real UI + data | - |
| 04 | Social Media | Real UI (+ data flag) | - |
| 05 | Inbox | Real UI restructure | - |
| 06 | Outreach IA split (Commercial Outreach / Reactivation / Group Outreach) | Nav + shells | - |
| 07 | Reactivation inner pages | Real UI + data | 06 |
| 08 | Leads cleanup (intro-call removal only) | UI cleanup | - |
