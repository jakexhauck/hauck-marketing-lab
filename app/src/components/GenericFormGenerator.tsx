    ...
    return (
      <span
        ...
        style={{
          ...
          padding: "1px 6px",
          border: "1px solid var(--hml-accent-border, color-mix(in srgb, var(--brand) 35%, transparent))",
          background: "var(--hml-accent-dim, color-mix(in srgb, var(--brand) 8%, transparent))",
          borderRadius: 4,
            ...
            >
              <div
                style={{
                  height: "100%",
                  width: `${progress.pct}%`,
                  background: "var(--copper, var(--brand))",
