// Display formatters shared by the merged desktop surfaces. Money and counts
// lean on the mono "ledger" treatment in the markup; these just produce the
// strings. The empty-value placeholder is a plain hyphen (never an em dash).
...
// Compact figures for large counts (impressions, reach): 1.2M, 45.3K.
...
// A rate already expressed as a fraction (0.0234 -> "2.34%").
...
// A return multiple (3.42 -> "3.42x"). Used for ROAS; never gold (not money).
