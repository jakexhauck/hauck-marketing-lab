// SOP seed data for the admin SOP Hub. Phase 1: static seed so the hub is fully
// browsable. Phase 2 swaps this for a Supabase-backed table + an admin editor
// (add / edit). Shape stays identical. Ported from the internal site.
