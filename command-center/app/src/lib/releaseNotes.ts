...
export const RELEASES: Release[] = [
  ...
  },
  {
    ...
    items: [
      "Acquisition now shows Leads and Cold Call only.",
      "An old link to the SMS page opens Leads instead.",
    ],
  },
  {
  ...
  },
  {
    ...
    items: [
      ...
      "Everything in it is what it was: the same variation buttons, the same script, the same button in the header to show and hide it.",
      "Objection handling no longer renders under the script. The dialing script is the script. The document itself is untouched under Management > Scripts.",
  ...
  },
  {
    ...
    items: [
      ...
      "The band now tracks what actually happens to a call: Calls Cancelled, No Shows, Unqualified, No-Close, Follow-Up and Closed. The last four add up to Live Calls exactly, so nothing is counted twice and nothing falls through a gap. No-Close used to mean 'turned up and did not close', which quietly swallowed the follow-ups and the unqualified.",
      "No 1hr Intent is gone, along with its percentage and Total No Show Rate. Nothing records whether a prospect stayed the hour, so all three were zero for ever, and Total No Show Rate without it was just No Show Rate printed twice.",
      "Seven columns have nothing to read from yet and are deliberately blank: Post Call Form, Assigned Closer, Set By, Payment Type, Payments Complete, Call Recording Link and Payment Status. Nothing on this page is typed, so an empty cell means the app has not been told, not that the month was quiet.",
