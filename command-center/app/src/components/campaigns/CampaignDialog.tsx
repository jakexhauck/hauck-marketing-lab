...
// Shared overlay for the Campaigns flows (new campaign, campaign report,
// audience detail). Centered modal on desktop, bottom sheet on mobile. Closes on
// backdrop click or Escape. The body scrolls; header and (optional) footer stay
// pinned. Mirrors the Social section's SocialDialog.
