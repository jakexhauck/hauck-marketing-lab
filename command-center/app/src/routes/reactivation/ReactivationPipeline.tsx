  ...
  return (
    <Shell>
      <div className={PAGE_CONTAINER}>
        ...
        {!populated ? (
          <>
            <NotConnectedNotice message="Once your customer list is linked, the people we reach out to will flow through these stages here." />
            <Panel className="overflow-hidden">
              <div className="px-4 py-10">
                <EmptyState
                  icon={<RotateCcw size={22} />}
                  title="Not started yet"
                  description="When the win-back campaign starts reaching your dormant customers, you'll see how many are at each stage."
                />
              </div>
            </Panel>
          </>
          ...
          <>
            {/* Read-only funnel: one column per stage, in journey order, each
                measured against everyone reached. */}
