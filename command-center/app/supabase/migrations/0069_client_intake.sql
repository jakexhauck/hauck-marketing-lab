-- 0069_client_intake.sql — the public client intake funnel (service-role only)
--
...
--
-- Written as 0056 on the feat/client-onboarding branch and renumbered on the way
-- to main, which had reached 0068 while that branch was paused.
--
-- See docs/build-plans/onboarding-funnel-board.md.
