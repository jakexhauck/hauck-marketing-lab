// WILLIS WINDOWS — the Thank You page of williswindows.com, served rather than pasted.
//
// GoHighLevel holds a two-line stub on the "Thank You" page and nothing else:
//
//     <div id="wws"></div>
//     <script src="https://app.hauckmarketing.com/sites/willis/site/thank-you.js"></script>
//
...
<main>
<section class="ww-banner" style="text-align:center">
  <div class="ww-wrap">
    <div class="ww-eyebrow" style="justify-content:center">Request received</div>
    <h1>Thanks — we've got it.</h1>
    <p style="margin:0 auto">One of the owners will call you shortly with your free estimate. Keep an eye out for a Metro Detroit number.</p>
    <div class="ww-hero__cta" style="justify-content:center">
      <a class="ww-btn ww-btn--sun" href="tel:3134053227">Call us now instead</a>
    </div>
  </div>
</section>
...
<section class="ww-sect">
  <div class="ww-wrap">
    <div class="ww-eyebrow">What happens next</div>
    <h2>Three steps, no surprises</h2>
    <div class="ww-grid ww-grid--3" style="margin-top:clamp(30px,4vw,46px)">
      <article class="ww-card"><div class="ww-card__body">
        <div class="ww-card__kicker">Step 1</div>
        <h3>We call you</h3>
        <p>Usually within the hour during business hours. We'll ask roughly how many windows you have and whether you want inside and out.</p>
      </div></article>
      <article class="ww-card"><div class="ww-card__body">
        <div class="ww-card__kicker">Step 2</div>
        <h3>You get a firm price</h3>
        <p>On that same call. No estimator visit, no follow-up email you have to chase, no pressure to book on the spot.</p>
      </div></article>
      <article class="ww-card"><div class="ww-card__body">
        <div class="ww-card__kicker">Step 3</div>
        <h3>We put you on the schedule</h3>
        <p>Pick a day that works. Most homes take two to three hours, and we walk the job with you before we leave.</p>
      </div></article>
    </div>
  </div>
</section>
...
<section class="ww-sect ww-sect--navy">
  <div class="ww-wrap">
    <div class="ww-feat">
      <div>
        <div class="ww-eyebrow">While you wait</div>
        <h2>Here's what you're getting</h2>
        <ul class="ww-list">
          <li><svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#4291BC" stroke-width="2.6" stroke-linecap="round" stroke-linejoin="round"><path d="M20 6 9 17l-5-5"/></svg><span><strong>0 PPM pure water</strong> — filtered in three stages so your glass air-dries without a single mineral spot</span></li>
          <li><svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#4291BC" stroke-width="2.6" stroke-linecap="round" stroke-linejoin="round"><path d="M20 6 9 17l-5-5"/></svg><span><strong>No ladders</strong> — water-fed poles reach three stories from the ground, so nothing leans on your gutters or landscaping</span></li>
          <li><svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#4291BC" stroke-width="2.6" stroke-linecap="round" stroke-linejoin="round"><path d="M20 6 9 17l-5-5"/></svg><span><strong>Screens, tracks &amp; sills</strong> included in every residential clean</span></li>
          <li><svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#4291BC" stroke-width="2.6" stroke-linecap="round" stroke-linejoin="round"><path d="M20 6 9 17l-5-5"/></svg><span><strong>Licensed &amp; fully insured</strong>, uniformed crew, and a real walkthrough at the end</span></li>
        </ul>
      </div>
      <div class="ww-meter">
