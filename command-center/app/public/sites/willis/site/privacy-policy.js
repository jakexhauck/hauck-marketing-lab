// WILLIS WINDOWS — the Privacy Policy page of williswindows.com, served rather than pasted.
//
// GoHighLevel holds a two-line stub on the "Privacy Policy" page and nothing else:
//
//     <div id="wws"></div>
//     <script src="https://app.hauckmarketing.com/sites/willis/site/privacy-policy.js"></script>
//
...
<section class="ww-banner">
  <div class="ww-wrap">
    ...
    <p>How Willis Windows collects, uses, and protects the information you share with us.</p>
  </div>
</section>
...
<section class="ww-sect">
  <div class="ww-wrap">
    <div class="ww-legal">
      ...
      <h2>1. Who we are</h2>
      <p>Willis Windows LLC ("Willis Windows," "we," "us," or "our") is a residential and commercial window cleaning company operating in Metro Detroit, Michigan. This policy explains what we collect when you use this website or contact us, and what we do with it.</p>

      <h2>2. Information we collect</h2>
      <ul>
        <li><strong>Information you give us.</strong> Your name, phone number, email address, service address, and anything else you tell us when you fill out a form, call, text, or email.</li>
        <li><strong>Information collected automatically.</strong> Basic technical data such as IP address, browser and device type, referring page, and pages viewed. This comes from cookies and similar technologies.</li>
        <li><strong>Marketing attribution data.</strong> If you arrive from an ad or a link with tracking parameters, we record which source sent you so we know which advertising works.</li>
      </ul>

      <h2>3. How we use your information</h2>
      <ul>
        <li>To contact you with your free estimate and to schedule, perform, and follow up on services.</li>
        <li>To send appointment confirmations, reminders, and service updates by phone, text, or email.</li>
        <li>To send occasional promotions or seasonal reminders, which you can opt out of at any time.</li>
        <li>To improve this website, our advertising, and our service quality.</li>
        <li>To comply with legal obligations and to protect our rights and property.</li>
      </ul>

      <h2>4. Text messages and calls</h2>
      <p>When you submit a form or give us your number, you agree that Willis Windows may contact you by phone call and SMS text message about your estimate and your service. Message frequency varies. Message and data rates may apply. Reply <strong>STOP</strong> to any text to opt out, or <strong>HELP</strong> for help. Opting out of marketing texts does not stop transactional messages about a job you have already booked.</p>
      <p><strong>We do not sell, rent, or share your phone number or SMS consent with third parties or affiliates for their own marketing purposes.</strong></p>

      <h2>5. How we share information</h2>
      <p>We do not sell your personal information. We share it only with:</p>
      <ul>
        <li><strong>Service providers</strong> who help us operate — for example our scheduling and customer messaging platform, email provider, website host, and payment processor. They may only use your information to perform services for us.</li>
        <li><strong>Legal and safety recipients</strong> when required by law, subpoena, or to protect the rights, property, or safety of Willis Windows, our customers, or the public.</li>
        <li><strong>A successor</strong> in the event of a merger, acquisition, or sale of assets.</li>
      </ul>

      <h2>6. Cookies and analytics</h2>
      <p>This site uses cookies and similar technologies to keep the site working, remember your preferences, and measure how visitors use it. We may also use advertising pixels, including from Meta, to measure ad performance and show relevant ads. Most browsers let you block or delete cookies in their settings; some parts of the site may not work correctly if you do.</p>

      <h2>7. Data retention</h2>
      <p>We keep your information for as long as needed to provide services, meet our legal and accounting obligations, resolve disputes, and enforce our agreements. When it is no longer needed, we delete it or make it anonymous.</p>
      ...
      <ul>
        <li><strong>Access, correction, or deletion.</strong> Contact us and we will honor reasonable requests to access, correct, or delete the personal information we hold about you.</li>
        <li><strong>Marketing opt-out.</strong> Reply STOP to any text, use the unsubscribe link in any email, or call us and ask to be removed.</li>
        <li><strong>State privacy rights.</strong> Residents of certain states may have additional rights over their personal information. Contact us to exercise them; we will not discriminate against you for doing so.</li>
      </ul>

      <h2>10. Children</h2>
      <p>This website is not directed to children under 13, and we do not knowingly collect personal information from them. If you believe a child has given us information, contact us and we will delete it.</p>

      <h2>11. Third-party links</h2>
      <p>Our site may link to other websites, such as our Google or Facebook pages. We are not responsible for their privacy practices, and we encourage you to read their policies.</p>

      <h2>12. Changes to this policy</h2>
      <p>We may update this policy from time to time. The effective date at the top will always show when it was last revised, and continued use of the site after an update means you accept the revised policy.</p>
