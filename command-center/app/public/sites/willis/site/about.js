// WILLIS WINDOWS — the About page of williswindows.com, served rather than pasted.
//
// GoHighLevel holds a two-line stub on the "About" page and nothing else:
//
//     <div id="wws"></div>
//     <script src="https://app.hauckmarketing.com/sites/willis/site/about.js"></script>
//
...
<section class="ww-banner">
  <div class="ww-wrap">
    <div class="ww-eyebrow">About us</div>
    <h1>Started young. Built to last.</h1>
    <p>Willis Windows is a Metro Detroit window cleaning company run by the two people who answer the phone.</p>
  </div>
</section>
  ...
  <div class="ww-wrap">
    <div class="ww-feat">
      <div class="ww-feat__img">
        <img src="__IMG__cleaning-glass.webp" alt="Willis Windows cleaning glass at a Metro Detroit home">
      </div>
      <div>
        <div class="ww-eyebrow">Our story</div>
        <h2>One pole, one truck, a lot of doors</h2>
        <p>Josh Willis and Jayse Gehringer started Willis Windows straight out of high school. No investors, no inherited customer list — just a water-fed pole, a filtration setup they saved for, and a neighborhood full of houses with dirty windows.</p>
        <p>They knocked doors. They did the jobs nobody else wanted to bid. They learned that most of the complaints homeowners have about window cleaners aren't about glass at all — they're about crews that show up late, leave ladder dents in the gutters, skip the tracks, and disappear when something goes wrong.</p>
        <p>So they built the company around fixing exactly those things. Metro Detroit News picked up the story. Today Willis Windows runs two crews and six trained cleaners across the metro — and both owners still work jobs and still answer the phone.</p>
        <div class="ww-hero__cta">
          <a class="ww-btn ww-btn--primary" href="/contact">Get a free estimate</a>
        </div>
      </div>
    </div>
  </div>
...
<section class="ww-sect ww-sect--wash">
  <div class="ww-wrap">
    ...
    <p class="ww-lede">Not a call center, not a franchise. When you book Willis Windows, one of these two put you on the schedule.</p>
    <div class="ww-feat" style="margin-top:clamp(30px,4vw,48px)">
      <div class="ww-feat__img ww-feat__img--tall">
        <img src="__IMG__owners.webp" alt="Josh Willis and Jayse Gehringer, owners of Willis Windows">
      </div>
      <div>
        <h3>Josh and Jayse</h3>
        <p>Between them they handle scheduling, the crews, the commercial accounts, and the equipment. If you called for an estimate, you talked to one of them. If something goes sideways on a job, they're the ones who fix it.</p>
        <div class="ww-duo">
          <div>
            <span>Owner</span>
            <b>Josh Willis</b>
            <p>Scheduling and residential crews.</p>
          </div>
          <div>
            <span>Co-owner</span>
            <b>Jayse Gehringer</b>
            <p>Commercial accounts and equipment.</p>
          </div>
        </div>
      </div>
    </div>
...
<section class="ww-sect ww-sect--navy">
  <div class="ww-wrap">
    <div class="ww-feat">
      <div>
        <div class="ww-eyebrow">How we work</div>
        <h2>Four things we don't compromise on</h2>
        <p class="ww-lede">These aren't slogans. They're the reasons customers call us back the next season.</p>
        <ul class="ww-list">
          <li><svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#4291BC" stroke-width="2.6" stroke-linecap="round" stroke-linejoin="round"><path d="M20 6 9 17l-5-5"/></svg><span><strong>Pure water only.</strong> Filtered in three stages to 0 PPM, tested before we start. Mineral-free water is the whole reason your glass dries clear.</span></li>
          <li><svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#4291BC" stroke-width="2.6" stroke-linecap="round" stroke-linejoin="round"><path d="M20 6 9 17l-5-5"/></svg><span><strong>Feet on the ground.</strong> Water-fed poles reach three stories, so nothing leans on your gutters and nobody risks a fall on your property.</span></li>
          <li><svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#4291BC" stroke-width="2.6" stroke-linecap="round" stroke-linejoin="round"><path d="M20 6 9 17l-5-5"/></svg><span><strong>The whole window.</strong> Screens, tracks, and sills are included — not a surprise line item once we're already there.</span></li>
          <li><svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#4291BC" stroke-width="2.6" stroke-linecap="round" stroke-linejoin="round"><path d="M20 6 9 17l-5-5"/></svg><span><strong>A real price, on the first call.</strong> Free estimates over the phone, usually within the hour. No estimator visit, no pressure.</span></li>
        </ul>
      </div>
      <div class="ww-meter">
...
<section class="ww-sect ww-cta">
  <div class="ww-wrap">
    ...
    <div class="ww-cta__row">
      <a class="ww-btn ww-btn--sun" href="/contact">Get my free estimate</a>
