...
const TENANT_COLUMNS =
  "id, slug, name, niche, brand_color, brand_initials, app_name, won_label, value_label, ghl_location_id, subdomain, owner_password_hash, monthly_spend, created_at, health_status, health_note";
