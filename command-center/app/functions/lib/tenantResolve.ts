...
const TENANT_COLS =
  "id, slug, name, niche, brand_color, brand_initials, app_name, won_label, value_label, ghl_location_id, ghl_token, meta_ad_account_id, google_place_id, owner_password_hash, monthly_spend";
